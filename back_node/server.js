...
// Try loading .env.node first for explicit separation
const fs = require('fs');
const envPath = fs.existsSync(__dirname + '/.env.node') ? __dirname + '/.env.node' : __dirname + '/.env';
...
app.use('/api', createProxyMiddleware({
    ...
    onProxyReq: (proxyReq, req, res) => {
        console.log(`[Proxy] Forwarding ${req.method} ${req.url} -> ${MODEL_BASE_URL}`);
    },
